...
from eqt.ui import UISliderEditWidget

# from PySide2 import QtWidgets


class TestUISliderEditWidget(unittest.TestCase):
    def setUp(self):
        self.widget = UISliderEditWidget()

    def _test_init_default_widget(self):
        self.assertIsInstance(self.widget, UISliderEditWidget)
    ...
    def _test_input_custom_min_max(self):
        self.widget = UISliderEditWidget(minimum=5.0, maximum=100.0)

        self.assertEqual(self.widget.minimum, 0.0)
        self.assertEqual(self.widget.maximum, 1.0)

    def _test_input_negative_min_max(self):
        self.widget = UISliderEditWidget(minimum=-1.0, maximum=0.0)
